...
public class JsonTest
{
	public static void main(String[] args)
	{
		...
		SampleClass jsonObject1 = new SampleClass("Test1", 9716, new String[] { "item1", "item2", "item3" });
		SampleClass jsonObject2 = new SampleClass("Test2", 9716, new String[] { "item1", "item2", "item3" });
		...
		List<SampleClass> list2 = Deserialize(json, new ArrayList<SampleClass>());
		
		System.out.println(list2.get(0).number);
		System.out.println(list2.get(1).number);
