...
public class anasayfa extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		out.println(docType
				...
				+ "<li>"
				+ "<img src='WebContent/img/dummies/slides/01.jpg' title='' alt='alt' width='940' height='400' />"
				...
				"<li>"
				+ "<img src='WebContent/img/dummi2es/slides/.jpg' title='' alt='alt'width='940' height='400' />  "
				+
				...
				"<li>"
				+ "<img src='WebContent/img/dummies/slides/3.jpg' title='' alt='alt'width='940' height='400' />"
				+
				...
				+ " </ul>" + "</div>" + "<div class='button-next'>Ýleri</div>"
