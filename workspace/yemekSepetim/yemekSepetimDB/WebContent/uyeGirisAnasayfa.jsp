	...
	<body class="home">
		...
		<header>
			<div class="wrapper cf">
				...
				<div id="logo">
					<a href="uyeGirisAnasayfa.jsp"><img  src="img/logo.png" alt="Simpler"></a>
				</div>
		...
		<div id="main">
			...
			<div class="home-featured">
				...
				<ul id="filter-buttons">
					<li><a href="hakkimizda.jsp" data-filter="*" class="selected">Hakkımızda</a></li>
					<li><a href="iletisim.jsp" data-filter=".web">İletişim Bilgilerimiz</a></li>
				</ul>
