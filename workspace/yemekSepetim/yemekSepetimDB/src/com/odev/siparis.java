...
public class siparis extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		out.println(docType
				...
				"<div id='logo'>"
				+ "<a href='uyeGirisAnasayfa.html'><img  src='img/logo.png' alt='Simpler'></a>"
				+ "</div>"
				+

				"<ul id='nav' class='sf-menu' >"
				+ "<li class='current-menu-item'><a href='uyeGirisAnasayfa.html'>Anasayfa</a></li>"
				+ "<li><a href='siparis'>Sipariþ Ver</a>"
				+ "<li><a href='cikis.html'>Çýkýþ Yap</a>"
				+
		...
		"</tr>" + "<tr><td><h5>Adet</h5></td>"
				+ "<TD><input type='text' name='yemekAdet' value = 1></TD>"
		...
		out.print("</select></td>"
				...
				"</tr>"
				+ "<tr><td><h5>Adet</h5></td>"
				+ "<TD><input type='text' name='icecekAdet' value = 1></TD>"
		...
		out.print("</select></td>"
				...
				+ "<TD></br><input type='text' name='salataAdet' value = 1></TD>"
				...
				+ "	<li><a href='iletisim.html' > Ýletiþim Bilgilerimiz</a></li>"
				+ "</ul></div></div></div></div>"
