...
/**
 * Servlet implementation class uyeHataliKayit
 */
@WebServlet("/uyeHataliKayit")
public class uyeHataliKayit extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public uyeHataliKayit() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		out.println(docType
				...
				"<table>"
				+ "<TR><TD>Adiniz:</TD>"
				+ "<TD colspan=5><input typ'text'  name='AdÄ±nÄ±z' value = ''>  </TD>"
				+ "</TR>"
				+ "<TR><TD>Soyadiniz:</TD>"
				+ "	<TD colspan=5><input type='text'  name='SoyadÄ±nÄ±z' value = '' > </TD>"
				+ "</TR>"
				+ "<TR><TD>Telefon Numaraniz:</TD>"
				+ "	<TD colspan=5><input type='text'  name='Telefon numaranÄ±z' value = '' > </TD>"
				+ "</TR>"
				...
				+ "<TR><TD>Sehriniz:</TD>"
				+ "	<TD><select name='city'>  "
				+ "		<option value='Default'>(Lütfen yaþadýðýnýz þehri seçiniz)</option>"
				...
				"<INPUT TYPE='SUBMIT' VALUE='Kayýt Ol'>"
				+ "<h5>Bilgileriniz uyuþmuyor lütfen doðru giriniz...</h5>  "
				+ "</fielset></form>     </div>        </br> "

				+ "</fielset> " + "</form>" + "</header>" + "<div id='main'>"
