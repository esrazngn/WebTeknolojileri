...
/**
 * Servlet implementation class cikisYap
 */
@WebServlet("/cikisYap")
public class cikisYap extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		out.println(docType
				...
				+ "Çýkýþ iþleminiz baþarý iþe gerçekleþtirildi..."
				+ "Anasayfaya gitmek için <a href=anasayfa.jsp>týklayýnýz</a> " + "<div id='main'>"
