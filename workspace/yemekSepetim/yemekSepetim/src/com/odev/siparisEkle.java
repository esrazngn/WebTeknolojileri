...
public class siparisEkle extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		if (session.isNew()) {
			session.putValue("salatalar", new ArrayList<String>());
			session.putValue("yemekler", new ArrayList<String>());
			session.putValue("icecekler", new ArrayList<String>());
		...
		if (req.getParameter("salatalar") != null) 
		{
			...
			salata.add(req.getParameter("salataAdet"));
			int Sadet = Integer.parseInt(req.getParameter("salataAdet"));
			...
			yemek.add(req.getParameter("yemekAdet"));
			int Yadet = Integer.parseInt(req.getParameter("yemekAdet"));
			...
			icecek.add(req.getParameter("icecekAdet"));
			int Iadet = Integer.parseInt(req.getParameter("icecekAdet"));
		...
		out.println(docType
				...
				"<div id='portfolio-content' class='cf'>  " + "</header><h1>Sipariþiniz</h1></br></br><h4>Yemek Sipariþiniz</h4></br><table>");
		int i = 0, j = 2;
		while(i<yemekSiparis.size())
		{
			out.print("<li>"+yemekSiparis.get(i)+" "+ yemekSiparis.get(i+1)+" Tutar: "+yemek.get(j)+"</br>");
			i+=2;
			j+=3;
		}
		...
		{
			out.print("<li>"+icecekSiparis.get(k)+" "+ icecekSiparis.get(k+1)+" Tutar: "+icecek.get(l)+"</br>");
			k+=2;
			l+=3;
		}
		...
		{
			out.print("<li>"+salataSiparis.get(m)+" "+ salataSiparis.get(m+1)+" Tutar: "+salata.get(n)+"</br>");
			m+=2;
			n+=3;
		}
