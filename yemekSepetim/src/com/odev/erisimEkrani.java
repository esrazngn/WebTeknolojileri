 ...
 */
@WebServlet("/erisimEkrani")
public class erisimEkrani extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		out.println(docType
				...
				+ "<li><a href='cikis'>Çýkýþ Yap</a></li>"
				+
				...
				+ " <p align=center><h5>Admin Giriþi Lütfen Ýþlem Seçiniz</h5> </p>"
				+ "<form action = 'erisimEkraniSec'>"
				+ "<table border=0  cellpadding=1 align=center >"
				+ "<TR><TD><input type='submit' name='siparis' value='Siparis Ver'/></TD></tr>"
				+ "<TR><TD><input type='submit' name='listele' value='Sipariþ Listele'  /></TD></tr>"
				+ " </table>" + " </form>" + "</header></br></br>"

				+ "<div id='main'>" + "<div class='home-featured'>"
