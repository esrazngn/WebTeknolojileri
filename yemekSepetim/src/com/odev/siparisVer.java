...
public class siparisVer extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		// Retrieve the value of the query parameter "password" (from password
		// field)
		/*
		 * String icecek = request.getParameter("icecekler"); if (icecek ==
		 * null) { out.println("<p>Salata: MISSING</p>"); } else {
		 * out.println("<p>icecek: " + icecek + "</p>"); }
		 * 
		 * String icecekAdet = request.getParameter("icecekAdet"); if
		 * (icecekAdet == null) { out.println("<p>ÝcecekAdt: MISSING</p>"); }
		 * else { out.println("<p>icecekadet: " + icecekAdet + "</p>"); }
		 * 
		 * 
		 * 
		 * String salata = request.getParameter("salatalar"); if (salata ==
		 * null) { out.println("<p>Salata: MISSING</p>"); } else {
		 * out.println("<p>Salata: " + salata + "</p>"); }
		 * 
		 * String salataAdet = request.getParameter("salataAdet"); if
		 * (salataAdet == null) { out.println("<p>Salata: MISSING</p>"); } else
