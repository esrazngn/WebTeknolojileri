			...
			<div class="wrapper cf">
				...
				<div id="home-slider" class="lof-slidecontent">
					...
					<ul class="sliders-wrap-inner">
					    <li>
					          <img src="img/dummies/slides/1.jpg" title="" alt="alt" width="940" height="400" />           
					          <div class="slider-description">
					            <h4>Yemek</h4>
					            <p>daha fazlası falan filan
								<a class="link" href="#">Bana tıkla </a>
					            </p>
					         </div>
					    </li>
					    
					    <li>
					          <img src="img/dummies/slides/2.jpg" title="" alt="alt" width="940" height="400"/>           
					          
					    </li>
					    
					    <li>
					          <img src="img/dummies/slides/03.jpg" title="" alt="alt" width="940" height="400"/>           
					          
					    </li>
					    
					    <li>
					          <img src="img/dummies/slides/04.jpg" title="" alt="alt"width="940" height="400" />           
					         
					    </li>
					    
					    <li>
					          <img src="img/dummies/slides/05.jpg" title="" alt="alt"width="940" height="400" />           
					...
					<div class="navigator-content">
					  ...
					  <div class="button-next">İleri</div>
